...
static int LCD_get_panel_para_mapping(const disp_panel_para_mapping **p_mapping)
{
	static const disp_panel_para_mapping mapping[] = {
		{
...
__lcd_panel_t gm7123c_rgb2vga_panel = {
