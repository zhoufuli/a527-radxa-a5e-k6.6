...
static const char *sys24M_parents[] = {"sys24M"};
struct factor_init_data sunxi_factos[] = {
	...
	{"pll_periph0_2x", sys24M_parents, 1,          0,                    PLL_PERIPH0, PLL_PERIPH0, LOCKBIT(28), PLL_PERIPH0, 29,          PLL_LOCK_NEW_MODE, &sunxi_clk_factor_pll_periph0_2x, &get_factors_pll_periph0_2x, &calc_rate_pll_periph, (struct clk_ops *)NULL},
	{"pll_periph1_2x", sys24M_parents, 1,          0,                    PLL_PERIPH1, PLL_PERIPH1, LOCKBIT(28), PLL_PERIPH1, 29,          PLL_LOCK_NEW_MODE, &sunxi_clk_factor_pll_periph1_2x, &get_factors_pll_periph1_2x, &calc_rate_pll_periph, (struct clk_ops *)NULL},
	{"pll_periph1_800m", sys24M_parents, 1,          0,                    PLL_PERIPH1, PLL_PERIPH1, LOCKBIT(28), PLL_PERIPH1, 29,          PLL_LOCK_NEW_MODE, &sunxi_clk_factor_pll_periph1_800m, &get_factors_pll_periph1_800m, &calc_rate_pll_periph, (struct clk_ops *)NULL},
	{"pll_video0x4",    sys24M_parents,    1,		CLK_NO_DISABLE,      PLL_VIDEO0,  PLL_VIDEO0,  LOCKBIT(28), PLL_VIDEO0,   29,         PLL_LOCK_NEW_MODE,  &sunxi_clk_factor_pll_video0x4,  &get_factors_pll_video0x4,  &calc_rate_video0,        (struct clk_ops *)NULL},
	{"pll_video3x4",    sys24M_parents,    1,		CLK_NO_DISABLE,      PLL_VIDEO3,  PLL_VIDEO3,  LOCKBIT(28), PLL_VIDEO3,   29,         PLL_LOCK_NEW_MODE,  &sunxi_clk_factor_pll_video3x4,  &get_factors_pll_video3x4,  &calc_rate_video0,        (struct clk_ops *)NULL},
};
...
struct periph_init_data sunxi_periphs_init[] = {
	...
	{"dpss_top0",     0,                    sys24M_parents,           ARRAY_SIZE(sys24M_parents),           &sunxi_clk_periph_dpss_top0       },
	{"dpss_top1",     0,                    sys24M_parents,           ARRAY_SIZE(sys24M_parents),           &sunxi_clk_periph_dpss_top1       },
	...
	{"edp_24m",      0,                    sys24M_parents,       ARRAY_SIZE(sys24M_parents),       &sunxi_clk_periph_edp_24m        },
};
...
void init_clocks(void)
{
	...
	clk_register_fixed_rate(NULL, "dcxo24M", NULL, CLK_IS_ROOT, 24000000);
	clk_register_fixed_rate(NULL, "dcxo19_2M", NULL, CLK_IS_ROOT, 19200000);
	clk_register_fixed_rate(NULL, "dcxo26M", NULL, CLK_IS_ROOT, 26000000);
