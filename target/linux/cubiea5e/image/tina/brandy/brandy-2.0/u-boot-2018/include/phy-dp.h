...
struct phy_configure_opts_dp {
	...
	unsigned int remap[4];

	unsigned int invert[4];
	 ...
	 * @set_lane_reamp:
	 *
	 * Flag indicating, whether or not remap lane's mapping
	 *
	 */
	u8 set_lane_remap : 1;
	 ...
	 * @set_lane_invert:
	 *
	 * Flag indicating, whether or not invert lane's signal
	 *
	 */
	u8 set_lane_invert : 1;
};
