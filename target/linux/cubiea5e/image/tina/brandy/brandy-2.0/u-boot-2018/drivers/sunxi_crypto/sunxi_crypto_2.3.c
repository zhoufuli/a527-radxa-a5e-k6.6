...
#define BUFF_LEN (68)
	...
	ALLOC_CACHE_ALIGN_BUFFER(u8, temp_src_addr, BUFF_LEN * 12 + CACHE_LINE_SIZE) ;
	ALLOC_CACHE_ALIGN_BUFFER(u8, temp_dst_addr, BUFF_LEN + CACHE_LINE_SIZE);

	u32 tmp_src, tmp_dst;
	struct other_task_descriptor task0;
	u32 ret = 0;
	u8 *p_tmp;
