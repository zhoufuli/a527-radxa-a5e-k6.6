...
#if defined(CONFIG_EDP2_SUPPORT_LM116X001A40_1920X1080) || \
	defined(CONFIG_EDP2_SUPPORT_LM116X001A40_1920X1080_MODULE)
extern struct __edp_panel LM116X001A40_1920X1080_panel;
#endif

#if defined(CONFIG_EDP2_SUPPORT_GENERAL_PANEL) || \
	defined(CONFIG_EDP2_SUPPORT_GENERAL_PANEL_MODULE)
