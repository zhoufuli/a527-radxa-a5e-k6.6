...
static void de_fcm_set_hue_lut(struct fcm_reg *reg, int *h, int *s, int *v)
{
	int i;
...
static void de_fcm_set_sat_lut(struct fcm_reg *reg, int *h, int *s, int *y)
{
	int i, j, m, n;
	for (i = 0; i < HUE_BIN_LEN; i++) {
...
static void de_fcm_set_lum_lut(struct fcm_reg *reg, int *h, int *s, int *y)
{
	int i, j, m, n;
	for (i = 0; i < HUE_BIN_LEN; i++) {
