/* u-boot-2014.07/drivers/video/sunxi/disp2/disp/lcd/lq079l1sx01.c
 *
...
static void lcd_panel_init(u32 sel)
{
	...
	sunxi_lcd_delay_ms(0x78);
	sunxi_lcd_dsi_dcs_write_1para(sel, 0x51, 0xff);
	sunxi_lcd_dsi_dcs_write_1para(sel + 1, 0x51, 0xff);
	sunxi_lcd_dsi_dcs_write_1para(sel, 0x55, 0x02);
	sunxi_lcd_dsi_dcs_write_1para(sel + 1, 0x55, 0x02);
	sunxi_lcd_dsi_dcs_write_1para(sel, 0x53, 0x2c);
	sunxi_lcd_dsi_dcs_write_1para(sel + 1, 0x53, 0x2c);
	sunxi_lcd_dsi_dcs_write_1para(sel, 0x35, 0x00);
	sunxi_lcd_dsi_dcs_write_1para(sel + 1, 0x35, 0x00);
	sunxi_lcd_dsi_dcs_write_0para(sel, DSI_DCS_SET_DISPLAY_ON);
	sunxi_lcd_dsi_dcs_write_0para(sel + 1, DSI_DCS_SET_DISPLAY_ON);
	sunxi_lcd_delay_ms(0x32);
}
...
static void lcd_panel_exit(u32 sel)
{
	...
	sunxi_lcd_delay_ms(20);
	sunxi_lcd_dsi_dcs_write_0para(sel + 1, DSI_DCS_SET_DISPLAY_OFF);
	sunxi_lcd_delay_ms(20);
	sunxi_lcd_dsi_dcs_write_0para(sel, DSI_DCS_ENTER_SLEEP_MODE);
	sunxi_lcd_delay_ms(20);
	sunxi_lcd_dsi_dcs_write_0para(sel + 1, DSI_DCS_ENTER_SLEEP_MODE);
...
__lcd_panel_t lq079l1sx01_panel = {
