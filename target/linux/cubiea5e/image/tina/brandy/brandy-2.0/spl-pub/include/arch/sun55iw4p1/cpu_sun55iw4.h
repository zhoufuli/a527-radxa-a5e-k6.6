#include <arch/sun55iw4p1/cpu_autogen.h>
...
#define SUNXI_SYSCRL_BASE	      (SUNXI_SYSCTRL_BASE)
#define SUNXI_CPU_SYS_CFG_BASE		(SUNXI_CPUS_CFG_BASE)
#define SUNXI_RPRCM_BASE		(SUNXI_R_PRCM_BASE)
#define SUNXI_CPUXCFG_BASE		(SUNXI_CPUS_CFG_BASE)
#define SUNXI_GPADC_BASE		(SUNXI_R_GPADC_BASE)
...
#define RVBARADDR0_L						(SUNXI_CPU_SUBSYS_CTRL_BASE + 0x40)
#define RVBARADDR0_H						(SUNXI_CPU_SUBSYS_CTRL_BASE + 0x44)
