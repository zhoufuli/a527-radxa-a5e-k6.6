...
#define CFG_SUNXI_GPT_ARD CFG_SPINOR_GPT_ARD
#elif defined(CFG_SUNXI_NAND)
#define CFG_SUNXI_GPT_ARD CFG_SPINAND_GPT_ARD
#else
#define CFG_SUNXI_GPT_ARD CFG_MMC_GPT_ARD
#endif
