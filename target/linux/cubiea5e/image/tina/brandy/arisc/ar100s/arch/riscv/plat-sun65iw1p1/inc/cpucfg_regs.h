...
/* CPUSCFG REGS */
#define CPUS_SPACE_LE_CTRL_REG  (R_CPUCFG_REG_BASE + 0x004C)
#define CPUS_SPACE_START_REG(n) (R_CPUCFG_REG_BASE + 0x0050 + n * 8)
#define CPUS_SPACE_END_REG(n)   (R_CPUCFG_REG_BASE + 0x0054 + n * 8)
