...
typedef struct dram_para {
	...
	unsigned int dram_rdqbit1[8];
	unsigned int dram_wdqbit1[8];
	unsigned int dram_rdqbit2[8];
	unsigned int dram_wdqbit2[8];
	unsigned int dram_rdqbit3[8];
	unsigned int dram_wdqbit3[8];
#endif
} __dram_para_t;
