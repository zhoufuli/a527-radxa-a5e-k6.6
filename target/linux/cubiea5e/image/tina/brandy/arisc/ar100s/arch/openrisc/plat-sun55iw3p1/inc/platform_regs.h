...
#define MCU_PRCM_REG_BASE       (0x07102000)
#define ADDA_REG_BASE           (0x07110000)
...
#define RTC_FAKE_POWEROFF_REG   (RTC_REG_BASE + 0x108)
...
#define S_PWM0_BUS_GATE_RST_REG     (R_PRCM_REG_BASE + 0x13c)
...
#define MCU_SYS_PWR_RST_REG         (R_PRCM_REG_BASE + 0x264)
...
#define VDD_SYS2MCU_GATING_SHIFT	(5)
#define VDD_MCU2CPUS_GATING_SHIFT	(4)
...
#define VDD_SYS2MCU_GATING_MASK		(0x1 << VDD_SYS2MCU_GATING_SHIFT)
#define VDD_MCU2CPUS_GATING_MASK	(0x1 << VDD_MCU2CPUS_GATING_SHIFT)
...
#define VDD_SYS2MCU_GATING(n)		((n) << VDD_SYS2MCU_GATING_SHIFT)
#define VDD_MCU2CPUS_GATING(n)		((n) << VDD_MCU2CPUS_GATING_SHIFT)
...
/* MCU_SYS_PWR_RST_REG */
#define MCU_SYS_MODULE_RST_SHIFT	(0)
#define MCU_SYS_MODULE_RST_MASK		(0x1 << MCU_SYS_MODULE_RST_SHIFT)
#define MCU_SYS_MODULE_RST(n)		((n) << MCU_SYS_MODULE_RST_SHIFT)
...
#define MCU_PLL_AUDIO_REG 			(MCU_PRCM_REG_BASE + 0x00c)
...
#define ADDA_POWER_REG		 	(ADDA_REG_BASE + 0x0348)
